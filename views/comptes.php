            ...
            <div class="card-body" id="sign_up">
                ...
                <!-- <script>
                    $(document).ready(function() {
                        $("#myforme").on('click', '.ajouter', function() {
                            var currentRow = $(this).closest("tr");
                            $('#id').val(currentRow.find("td:eq(0)").text());
                            $('#nom').val(currentRow.find("td:eq(1)").text());
                            $('#tele').val(currentRow.find("td:eq(2)").text());
                            $('#email').val(currentRow.find("td:eq(3)").text());
                            $('#adrs').val(currentRow.find("td:eq(4)").text());
                            $('#password').val(currentRow.find("td:eq(5)").text());
                            $('#pass').val(currentRow.find("td:eq(6)").text());
