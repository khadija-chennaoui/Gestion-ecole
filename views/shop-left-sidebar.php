                ...
                <div class="col-12">
                    <div class="breadcrumb_content text-center">
                        ...
                        <ul class="d-flex justify-content-center">
                            ...
                            <li>></li>
                            <li><a href="shop-left-sidebar.php">PRODUIT </a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <article class="single_product">
                                            ...
                                            <figure>
                                                <div class="product_thumb"style="WIDTH: 317px; height: 400px;">
                                                    <a href="single-product.php"><img src="views/assets/img/product/<?php echo $rows['1']?>" alt=""style="WIDTH: 100%; height: 100%;"></a>
                                                </div>
                                                <figcaption class="product_content">
                                                    <h4><a href=""><?php echo $rows['2']?></a></h4>
                                                    <div class="price_box">
