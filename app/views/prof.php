 <?php include('../models/professeur.php');
    ...
    if (isset($_POST['submit'])) {
        ...
        $phone = $_POST['Phone'];
        $class = $_POST['class_prof'];
        $insert = $mode->ajouterProfesseur($nom,$genre,$matière,$phone,$class);
        if ($insert) {
            echo 'okeeeeeeeeeee';
        } else {
            echo 'noooooo';
                         ...
                         <div class="modal-body">
                             <form class="form-container" action="" method="POST" onsubmit="return validation()">
                                 ...
                                 <div class="mb-3  fw-bold">
                                     ...
                                     <input type="text" class="form-control" id="class" name="class_prof" placeholder="Enter le class">
                                     <p id="img2" style="margin-bottom: -1rem;"></p>
